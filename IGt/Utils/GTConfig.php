...
class GTConfig
{
    ...
    public static function getDefaultDomainUrl($useSSL)
    {
        ...
        if ($urlStr == null || '' . equals(trim($urlStr))) {
            if ($useSSL) {
                $hosts = [
                    'https://cncapi.getui.com/serviceex',
                    'https://telapi.getui.com/serviceex',
                    'https://api.getui.com/serviceex',
                    'https://sdk1api.getui.com/serviceex',
                    'https://sdk2api.getui.com/serviceex',
                    'https://sdk3api.getui.com/serviceex'
                ];
            } else {
                $hosts = [
                    ...
                    'http://sdk1.open.api.igexin.com/serviceex',
                    'http://sdk2.open.api.igexin.com/serviceex',
                    'http://sdk3.open.api.igexin.com/serviceex'
                ];
            }
        } else {
            $list = explode(",", $urlStr);
